...
CASAS_ONEPIECE_CON_NOMBRES = {
    ...
    "Kuri": ["Casa_de_Oden", "Casa_de_Kozuki Hiyori", "Casa_de_Kozuki Momonosuke"],
    "Udon": ["Casa_de_Oden", "Casa_de_Kozuki Hiyori", "Casa_de_Kozuki Momonosuke"],
    "Flower_Capital": [
        "Casa_de_Oden",
        "Casa_de_Kozuki Hiyori",
        "Casa_de_Kozuki Momonosuke",
    ],
    "Ringo": ["Casa_de_Oden", "Casa_de_Kozuki Hiyori", "Casa_de_Kozuki Momonosuke"],
    "Onigashima": ["Casa_de_Kaido", "Casa_de_Orochi", "Casa_de_Yamato"],
    "Sweet_City": ["Casa_de_Big Mom", "Casa_de_Pudding", "Casa_de_Katakuri"],
    "Cacao_Island": ["Casa_de_Big Mom", "Casa_de_Pudding", "Casa_de_Katakuri"],
    "Caramel_Mountain": ["Casa_de_Big Mom", "Casa_de_Pudding", "Casa_de_Katakuri"],
    "Whole_Cake_Chateau": ["Casa_de_Big Mom", "Casa_de_Pudding", "Casa_de_Katakuri"],
    "Liqueur_Island": ["Casa_de_Big Mom", "Casa_de_Pudding", "Casa_de_Katakuri"],
}
